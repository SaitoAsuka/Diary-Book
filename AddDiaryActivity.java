...
public class AddDiaryActivity extends AppCompatActivity {
    ...
    private EditText addPage_author;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addPage_author=(EditText)findViewById(R.id.addPage_author);
        ...
        buttonConfirm.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                if(title.length()==0){
                    Toast.makeText(AddDiaryActivity.this, "You forget to input title!", Toast.LENGTH_SHORT).show();
                }else {
                    String author = addPage_author.getText().toString();//获取作者
